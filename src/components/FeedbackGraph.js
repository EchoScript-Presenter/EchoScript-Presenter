...
const speakerIcon = `${process.env.PUBLIC_URL}/images/speaker.png`;
...
function FeedbackGraph() {
  ...
  return (
    <div style={{ display: 'flex', width: '100%', height: '70%' }}>
      <div style={{ width: '100%' }}>
        <h2 style={{ width: '100%', marginLeft: '10px' }}>
          Real-time Feedback
        </h2>
      ...
      >
        {volumeData &&
          volumeData.value === 0 && ( // {volumeData && volumeData.value === 0 && <MdSpeakerNotesOff size={50} />}
